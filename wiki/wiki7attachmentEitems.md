...
> **Evidence** - We chose to utilize the USPTO pattern library (which ATS helped develop) as a foundation for many of the individual components used on the application.  In addition, we created a custom icons and symbols as a starting point in the design for the MEDWATCH Application.
